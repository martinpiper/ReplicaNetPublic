...
{
	m_strWindowTitle	= _T("Example9: Planes flying around");
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
	...
	if( FAILED( m_pDolphin->Create( m_pd3dDevice, _T("dolphin1.x") ) ) )
		return D3DAPPERR_MEDIANOTFOUND;
	...
	m_pDolphin->SetFVF( m_pd3dDevice, D3DFVF_VERTEX );
...
HRESULT CMyD3DApplication::RestoreDeviceObjects()
{
	...
	m_pDolphin->RestoreDeviceObjects( m_pd3dDevice );
...
HRESULT CMyD3DApplication::InvalidateDeviceObjects()
{
	...
	m_pDolphin->InvalidateDeviceObjects();
